...
const RotatingToolModel = lazy(() => import('./RotatingToolModel'))
...
export default function ScrollModel() {
  ...
  useEffect(() => {
    ...
    if (!target || shouldLoadModel) return undefined
    ...
    <section className="split-layout" ref={containerRef} id="main-content">
      <div className="split-left">
        ...
        <div className="model-container">
          {shouldLoadModel ? (
            <Suspense fallback={<div className="model-loading visible">Loading 3D model...</div>}>
              <RotatingToolModel progress={scrollYProgress} />
            </Suspense>
          ) : (
            <div className="model-loading visible">Loading 3D model...</div>
          )}
        </div>
      </div>
      ...
      <div className="split-right">
        <div className="content-panel panel-white">
          ...
          <p className="panel-desc">
            Incorporated in 1995, Aone Pattern is a versatile company capable of producing precision patterns. Customer satisfaction is our utmost priority and we strive to achieve that by delivering high-quality standards.
          </p>
          <p className="panel-desc">
        ...
        <div className="content-panel panel-red">
          ...
          <p className="panel-desc">
            Our competent infrastructural support manufactures high-end patterns, tools, and dies using advanced VMC machines. Our production unit consists of full in-house production to ensure predictable quality of each product.
          </p>
          <p className="panel-desc">
